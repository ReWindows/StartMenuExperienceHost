//! Windissect-generated Rust FFI bindings for StartMenuExperienceHost.exe. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "03FA474EDDD8E1EABEA626A7B633DC7E";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2908592615;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 28] = [83, 116, 97, 114, 116, 77, 101, 110, 117, 69, 120, 112, 101, 114, 105, 101, 110, 99, 101, 72, 111, 115, 116, 46, 101, 120, 101, 0];
        ...
        if live_timestamp != 2908592615 { return 0; }
